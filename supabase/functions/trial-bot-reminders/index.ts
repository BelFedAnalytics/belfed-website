...
function msgD5(lang: "ru" | "en", link: string, ends: string): string {
  if (lang === "en") return (
    ...
    "we've opened 50 exclusive Founding Member seats with a lifetime 30% discount at *$10.50/mo*.\n\n" +
  ...
  return (
    ...
    "\u0441 \u043f\u043e\u0436\u0438\u0437\u043d\u0435\u043d\u043d\u043e\u0439 \u0441\u043a\u0438\u0434\u043a\u043e\u0439 30% \u2014 *1 050 \u20bd/\u043c\u0435\u0441*.\n\n" +
...
function msgD1(lang: "ru" | "en", link: string, ends: string): string {
  if (lang === "en") return (
    ...
    "Only a few of the 50 exclusive Founding Member seats remain at *$10.50/mo*. Secure yours now to keep your early-user privileges:\n\n" +
  ...
  return (
    ...
    "\u041e\u0441\u0442\u0430\u043b\u043e\u0441\u044c \u043d\u0435\u0441\u043a\u043e\u043b\u044c\u043a\u043e \u0438\u0437 50 \u044d\u043a\u0441\u043a\u043b\u044e\u0437\u0438\u0432\u043d\u044b\u0445 \u043c\u0435\u0441\u0442 Founding Member \u2014 *1 050 \u20bd/\u043c\u0435\u0441*. \u0417\u0430\u0431\u0440\u043e\u043d\u0438\u0440\u0443\u0439\u0442\u0435 \u0441\u0432\u043e\u0451 \u0441\u0435\u0439\u0447\u0430\u0441, \u0447\u0442\u043e\u0431\u044b \u0441\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u043f\u0440\u0438\u0432\u0438\u043b\u0435\u0433\u0438\u0438 \u0440\u0430\u043d\u043d\u0435\u0433\u043e \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f:\n\n" +
