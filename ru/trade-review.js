...
(function () {
  ...
  var TRIAL_HREF = "https://belfed.ru/ru/trial.html?source=trial_tradehistory_modal_ru";
  ...
  var T = {
    ...
    promoH: "Следите за сделками BelFed в реальном времени",
    promoBody: "Оформите 14-дневный бесплатный доступ, чтобы получать профессиональную аналитику и моментальные оповещения о торговых идеях и наших сделках.",
    promoBtn: "Оформить бесплатный 14-дневный доступ",
  };
